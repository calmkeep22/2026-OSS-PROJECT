...
| 구간 | 적중률 | 95% 신뢰하한 | 건수 |
|---|---|---|---|
| 전체 | 53.22% | 50.65% | 1,443 |
| 확신도 **상위 50%** | **57.95%** | 54.35% | 723 |
| 확신도 **상위 30%** | **60.83%** | 56.24% | 434 |
| 확신도 **상위 20%** | **62.28%** | 56.70% | 289 |

확신이 클수록 잘 맞는다 — 모델이 아는 것과 모르는 것을 구분한다는 뜻이다.
국내 종목만 보면 전체 구간에서도 **54.79%**.
